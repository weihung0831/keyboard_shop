...
const DesktopNav = ({ navItems }: any) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        'fixed z-[60] hidden w-full flex-row items-center justify-between self-start bg-white px-8 py-4 lg:flex dark:bg-neutral-950',
        'inset-x-0 top-0',
      )}
    >
      <Logo />
  ...
  return (
    <>
      <motion.div
        ...
        key={String(open)}
        className='fixed top-0 left-0 right-0 z-[60] flex w-full flex-col items-center justify-between bg-white px-4 py-2 lg:hidden dark:bg-neutral-950'
      >
        <div className='flex w-full flex-row items-center justify-between'>
          <Logo />
          <div className='flex items-center space-x-1'>
            <button className='flex h-8 w-8 items-center justify-center text-neutral-600 hover:text-neutral-800 dark:text-neutral-300 dark:hover:text-white transition-colors'>
              <IconSearch size={20} />
            </button>
            <button className='flex h-8 w-8 items-center justify-center text-neutral-600 hover:text-neutral-800 dark:text-neutral-300 dark:hover:text-white transition-colors'>
              <IconUser size={20} />
            </button>
            <button className='relative flex h-8 w-8 items-center justify-center text-neutral-600 hover:text-neutral-800 dark:text-neutral-300 dark:hover:text-white transition-colors'>
